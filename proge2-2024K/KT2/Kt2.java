...
public class Kt2 {
    ...
    public static void väljastaOsajärjendid(int[] a) {
        ...
        b.addAll(väljastaOsajärjendidTSükkel(a, 0, 0));
    ...
    public static String väljastaOsajärjendidAbi(int[] a, int n){
        ArrayList<String> b = new ArrayList<String>();
        ...
        s += väljastaOsajärjendidAbi(a, n+2);

        return s;
    }

    public static ArrayList<String> väljastaOsajärjendidTSükkel(int[] a, int n, int i){
        ArrayList<String> b = new ArrayList<String>();
        if (n >= a.length){
            return b;
        }
        ...
        if (i != 0){
            b.add(väljastaOsajärjendidAbi(a, n + i));
        } else if (n + i == a.length-1) {
            b.addAll(väljastaOsajärjendidTSükkel(a, n+1, 0));
        } else if (i == 0){
            b.addAll(väljastaOsajärjendidTSükkel(a, n, 1));
        }
